    ...
    const handleContinue = async () => {
        ...
        try {
            ...
            if (data.success || response.ok) {
                ...
                toast.error(data.message || 'Failed to sign agreement. Please try again.');
            }
        } catch (error) {
    ...
    return (
        ...
        <>
            ...
            <div>
                ...
                >
                    <div
                        className={`w-5 h-5 min-w-[20px] min-h-[20px] border-2 flex items-start justify-start rounded-full flex-shrink-0 ${checked ? "border-[#00fb57] bg-[#00fb57]" : "border-gray-400 bg-transparent"
                            }`}
                    >
