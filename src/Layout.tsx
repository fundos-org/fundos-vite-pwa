...
export const Layout: FC<LayoutProps> = ({ children, backRoute, baseRoute }) => {
  ...
  return (
    <>
      ...
      <main className="min-h-[90vh] flex-1 flex-col justify-between w-full md:max-w-[360px] bg-black text-white box-border overflow-auto mx-auto overflow-x-hidden">
        {children}
      </main>
    </>
  );
